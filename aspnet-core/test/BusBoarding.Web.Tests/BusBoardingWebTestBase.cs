...
{
    public abstract class BusBoardingWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BusBoardingWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BusBoardingWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BusBoardingDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BusBoardingDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BusBoardingDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BusBoardingDbContext, Task<T>> func)
        {
            T result;
